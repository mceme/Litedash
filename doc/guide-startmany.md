...
[From the litedash github repo](https://github.com/dashpay/litedash/blob/master/doc/masternode_conf.md)
...
```litedash-cli getinfo```

and comparing with the official explorer at https://explorer.litedash.org/chain/Dash
...
```
litedash-cli masternode status
{
