...
Format: ```mngovernance prepare proposal-name url payment-count block-start litedash-address monthly-payment-litedash```
...
Format: ```mngovernance submit proposal-name url payment-count block-start litedash-address monthly-payment-litedash fee-tx```
...
The following RPC commands are supported:
 ...
 - mngovernance "command"... ( "passphrase" )
  ...
  - vote               - Vote on a proposal by single masternode (using litedash.conf setup)
