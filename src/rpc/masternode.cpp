...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    { "litedash",               "masternode",             &masternode,             true,  {} },
    { "litedash",               "masternodelist",         &masternodelist,         true,  {} },
    { "litedash",               "masternodebroadcast",    &masternodebroadcast,    true,  {} },
    { "litedash",               "getpoolinfo",            &getpoolinfo,            true,  {} },
    { "litedash",               "sentinelping",           &sentinelping,           true,  {} },
#ifdef ENABLE_WALLET
    { "litedash",               "privatesend",            &privatesend,            false, {} },
#endif // ENABLE_WALLET
};
