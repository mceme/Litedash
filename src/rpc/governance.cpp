...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    /* Dash features */
    { "litedash",               "getgovernanceinfo",      &getgovernanceinfo,      true,  {} },
    { "litedash",               "getsuperblockbudget",    &getsuperblockbudget,    true,  {"index"} },
    { "litedash",               "gobject",                &gobject,                true,  {} },
    { "litedash",               "voteraw",                &voteraw,                true,  {} },
