...
const char * const BITCOIN_CONF_FILENAME = "litedash.conf";
const char * const BITCOIN_PID_FILENAME = "litedashd.pid";
    ...
    if (category != NULL)
    {
        ...
        if (ptrCategory.get() == NULL)
        {
            if (mapMultiArgs.count("-debug")) {
                ...
                // "litedash" is a composite category enabling all Dash-related debug output
                if(ptrCategory->count(std::string("litedash"))) {
