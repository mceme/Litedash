 ...
 *
 * This is the developer documentation of the reference client for an experimental new digital currency called Dash (https://www.litedash.org/),
...
bool AppInit(int argc, char* argv[])
{
    ...
    try
    {
        ...
        if (fCommandLine)
        {
            fprintf(stderr, "Error: There is no RPC client functionality in dashd anymore. Use the litedash-cli utility instead.\n");
            exit(EXIT_FAILURE);
        }
